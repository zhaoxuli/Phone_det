...
python run.py --ref_w 40 \
          ...
          --label_quality_profile bad \
          --bbox_reg_profile preciser  \
          --constraint_mode fpga \
          --term_false_positive_rate 1E-7 \
          --ctx "0,1,2,3" \
          --model_max_layer_num 24 \
          --data_prefix /home/users/dawei.yang/phone_alpha/data/crop_data_new/train_rec_data/0228_All_rec/\
          --json_prefix /home/users/dawei.yang/phone_alpha/data/crop_data_new/train_rec_data/0228_All_rec/\
          --no_validation \
          --model_prefix /home/users/dawei.yang/phone_alpha/crop_0302_all_model/
